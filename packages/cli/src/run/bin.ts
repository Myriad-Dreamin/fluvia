/**
 * `fluvia run` — find the benchmark cases in a tree, execute them, and say
 ...
 * line-by-line detail is one `fluvia bench replay --json` away.
 */
