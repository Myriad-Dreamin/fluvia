 ...
 *
 * Usage:
 *   fluvia bench lines  --trace <file>
 *   fluvia bench replay --trace <file> --from <n> [--to <n>] [--concurrency <n>]
 *                       [--edit <n>=<line>]... [--json]
 *   fluvia bench export --trace <file> --out <file.json>
 *
